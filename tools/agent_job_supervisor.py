    ...
    def _build_command(self, job: dict[str, Any]) -> tuple[list[str], str | None, dict[str, str]]:
        ...
        if provider == "claude":
            ...
            argv = [
                ...
                "--allowed-tools", *tools,
                # ACO owns orchestration. Prevent a provider session from
                # recursively spawning Claude Agent workers that bypass the
                # parent job's concurrency, cancellation, and quota accounting.
